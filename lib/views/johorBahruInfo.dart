...
class johorBahruInfo extends StatefulWidget {
  @override
  _johorBahruInfoState createState() => _johorBahruInfoState();
}

class _johorBahruInfoState extends State<johorBahruInfo> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(
                    builder:(context){
                      return johorBahruThemeParkPage();
                    }
                )
                );
              },
